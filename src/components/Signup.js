				...
				>
					...
					>
						...
						<button
							...
							className={`${
								loading ? "cursor-wait bg-slate-600" : ""
							} inline-flex justify-center items-center py-4 w-full disabled:bg-slate-500 rounded bg-blue-700 hover:bg-blue-600 focus:bg-blue-800 text-base font-medium leading-none text-white`}
						>
							Register
							<svg
								className={`${
